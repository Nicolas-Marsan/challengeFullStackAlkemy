...
function Login(props) {
  ...
  const submit = async (e) => {
    ...
    if (res.data.info.userLogged) {
      sessionStorage.setItem("id", res.data.info.userLogged.id);
      sessionStorage.setItem("name", res.data.info.userLogged.first_name);
      sessionStorage.setItem("token",res.data.token);
      setUserGlobal(res.data.info.userLogged);
